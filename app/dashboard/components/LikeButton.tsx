  ...
  return (
    <div className="flex items-center gap-1">
      <button
        ...
        onClick={handleClick}
        disabled={loading}
        className="rounded p-1.5 text-slate-500 hover:bg-slate-100 hover:text-blue-600 disabled:opacity-50"
      ...
      <span className="min-w-[1.25rem] text-sm text-slate-600">{count}</span>
      {error && (
